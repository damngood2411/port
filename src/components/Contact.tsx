  ...
  return (
    <section id="contact" className="py-20 bg-slate-100 text-slate-900">
      <div className="container mx-auto px-4">
        ...
        {submitSuccess ? (
          <div className="max-w-md mx-auto bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-8 text-center">
        ...
        >
          ...
          <div className="mb-6">
            <label className="flex items-center text-slate-700">
              ...
              />
              <span className="text-sm">私はロボットではありません</span>
            </label>
